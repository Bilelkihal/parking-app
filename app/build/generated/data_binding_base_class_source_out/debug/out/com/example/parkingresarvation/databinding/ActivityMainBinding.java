...
public final class ActivityMainBinding implements ViewBinding {
  ...
  public static ActivityMainBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.menu_bottom;
      BottomNavigationView menuBottom = rootView.findViewById(id);
      if (menuBottom == null) {
        break missingId;
      }

      return new ActivityMainBinding((RelativeLayout) rootView, frameLayout, menuBottom);
    }
