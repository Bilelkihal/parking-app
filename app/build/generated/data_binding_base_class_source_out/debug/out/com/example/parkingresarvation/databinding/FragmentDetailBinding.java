...
public final class FragmentDetailBinding implements ViewBinding {
  ...
  @NonNull
  public final ImageButton btnItiniraire;
  ...
  private FragmentDetailBinding(@NonNull ConstraintLayout rootView,
      @NonNull ImageButton btnItiniraire, @NonNull Button button, @NonNull ImageView imageView2,
    ...
    this.btnItiniraire = btnItiniraire;
    this.button = button;
  ...
  public static FragmentDetailBinding bind(@NonNull View rootView) {
    ...
    int id;
    missingId: {
      id = R.id.btnItiniraire;
      ImageButton btnItiniraire = rootView.findViewById(id);
      if (btnItiniraire == null) {
        break missingId;
      }
      ...
      return new FragmentDetailBinding((ConstraintLayout) rootView, btnItiniraire, button,
          imageView2, imageView3, textView10, textView11, textView12, textView13, textView15,
          textView16, textView17, textView18, textView19, textView20, textView21, textView6,
          textView7, textView9, view2, view3, view4);
    }
